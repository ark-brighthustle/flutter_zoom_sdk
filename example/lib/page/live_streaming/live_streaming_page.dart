...
class _LiveStreamingPageState extends State<LiveStreamingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: onRefresh,
        color: kCelticBlue,
        child: SizedBox(width: size.width, height: size.height, child: live(size)),
      ),
        ...
        Expanded(
          child: ListView.builder(
              ...
              itemBuilder: (context, i) {
                ...
                String jamSelesai =
                    jadwalLiveList[i].jamSelesai.substring(0, 5);
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () => {
                            ...
                            {
                              joinMeeting(context, liveList[i].meetingId,
                                  liveList[i].passcode)
                            }
                          },
                          child: Container(
  ...
  joinMeeting(BuildContext context, meetingId, passcode) {
    ...
    if (meetingId.isNotEmpty && passcode.isNotEmpty) {
      ZoomOptions zoomOptions = ZoomOptions(
        domain: "zoom.us",
        appKey: "SCqq7P4YjhVnNxxdoXErV2JMqRveQ0yrNZCn", //API KEY FROM ZOOM
        appSecret:
            "4vlDdlhxwQcMu9QvYtColSwBpeeGdgcv0EfB", //API SECRET FROM ZOOM
      );
