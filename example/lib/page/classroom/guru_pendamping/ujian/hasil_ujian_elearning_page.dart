...
class HasilUjianElearningPage extends StatefulWidget {
  ...
  @override
  State<HasilUjianElearningPage> createState() =>
      _HasilUjianElearningPageState();
}
...
class _HasilUjianElearningPageState extends State<HasilUjianElearningPage> {
  ...
  getDetailHasilUjian() async {
    ...
    setState(() {
      var data = response['data'];
      listDetailHasilUjian =
          data.map((p) => DetailHasilUjianModel.fromJson(p)).toList();
    });
  }
              ...
              Positioned.fill(
                ...
                child: Container(
                    padding: const EdgeInsets.only(
                        left: padding, top: 8, right: padding, bottom: 48),
                    child: Column(
                        ...
                        Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Spacer(),
                                Text("Nilai ${listDetailHasilUjian[i].nilai}",
                                        ...
                                        onTap: () => Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                                builder: (context) => OpenImagePage(
                                                    title:
                                                        "Gambar soal no. ${listSoalUjian[i].id}",
                                                    img: listSoalUjian[i]
                                                        .image))),
                                        child: Image.network(
                                        ...
                                        onTap: () => Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                                builder: (context) =>
                                                    VideoPlayerWidget(
                                                        title:
                                                            "Vidio soal no. ${listSoalUjian[i].id}",
                                                        fileVideo:
                                                            listSoalUjian[i]
                                                                .video))),
                                        child: Container(
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                              ...
                                              color: listSoalUjian[i].jawaban ==
                                                      'a'
                                                  ? listSoalUjian[i].jawaban ==
                                                          listDetailHasilUjian[
                                                                  i]
                                                              .jawaban_benar
                                                      ? kGreen
                                                      : kRed
                                                  : listDetailHasilUjian[i]
                                                              .jawaban_benar ==
                                                          'a'
                                                      ? kGreen
                                                      : kGrey),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            if (listDetailHasilUjian[i]
                                              ...
                                              Text(
                                                "${listDetailHasilUjian[i].penjelasan_jawaban}",
                                                style: const TextStyle(
                                                    fontSize: 13),
                                              ),
                                            ],
                                              ...
                                              GestureDetector(
                                                onTap: () => Navigator.push(
                                                    ...
                                                    MaterialPageRoute(
                                                        builder: (context) => OpenImagePage(
                                                            title:
                                                                "Gambar penjelasan soal no. ${listSoalUjian[i].id}",
                                                            img: listDetailHasilUjian[
                                                                    i]
                                                                .gambar_penjelasan_jawaban))),
                                                child: Image.network(
                                                  listDetailHasilUjian[i]
                                                      .gambar_penjelasan_jawaban,
                                                  fit: BoxFit.cover,
